...
os.system("clear")
print(colored("                 <<<<<(WELCOME TO Baloch DEVELOPEMENT.)>>>>>","green"))
time.sleep(1.5)
os.system("clear")
	...
	class gh:
		...
		def ui(self):
			if not len(self.user)>13:
				print(colored("[!] Invalid user id.","blue"))
				sys.exit()
			else:
				os.system("clear")
				...
				print(colored(f"       https://m.facebook.com/group/add_admin/?group_id={self.group}&user_id={self.user}&added&_rdrChange$","purple"))
				print(colored(f"\n *******************************************************************************************************************","red"))
		#user=input(colored("[?] User id: ","cyan"))
		def gi(self):
